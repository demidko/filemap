### [`@filemapbot`](https://t.me/filemapbot) `= f(`[`message`](https://core.telegram.org/bots/api#message)`) →` [`your previous document id`](https://core.telegram.org/bots/api#document)
